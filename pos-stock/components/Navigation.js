...
export default function Navigation() {
    ...
    const crossLinks = getCrossAppLinks(appAccess, 'stock');
                ...
                <div className="d-flex align-items-center">
                    {user ? (
                        ...
                        <a
                            ...
                            href={`${APP_URLS.auth}/authorize?redirect_uri=${encodeURIComponent(`${APP_URLS.stock}/auth/callback`)}&state=${encodeURIComponent(router.asPath || "/")}`}
                        >
                            Login
                        </a>
                    )}
