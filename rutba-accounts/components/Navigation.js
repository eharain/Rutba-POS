...
export default function Navigation() {
    ...
    const crossLinks = getCrossAppLinks(appAccess, 'accounts');

    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark px-3 text-white">
            <Link className="navbar-brand fw-bold" href="/">Rutba Accounts</Link>
            ...
            <div className="collapse navbar-collapse" id="mainNav">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    <li className="nav-item">
                        <Link className="nav-link" href="/chart-of-accounts">Chart of Accounts</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link" href="/journal-entries">Journal Entries</Link>
                    </li>
                    <li className="nav-item">
                ...
                <div className="d-flex align-items-center">
                    ...
                    {user ? (
                        ...
                        <a
                            ...
                            href={`${APP_URLS.auth}/authorize?redirect_uri=${encodeURIComponent(`${APP_URLS.accounts}/auth/callback`)}&state=${encodeURIComponent(router.asPath || "/")}`}
                        >
                            Login
                        </a>
                    )}
