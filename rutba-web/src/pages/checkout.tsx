...
export default function CheckoutPage() {
  ...
  const countTotal = () => {
    return (
      (countSubTotal() ?? 0) +
      (formShippingService.price ? parseFloat(formShippingService.price) : 0)
    );
  };
              ...
              <CardContent className="my-6 pb-0">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <p className="font-bold text-sm">
                      {formShippingService.price
                        ? currencyFormat(parseFloat(formShippingService.price))
                        : "Select service to calculate"}
                    </p>
                  </div>
                  <div>
                    <hr className="my-2" />
          ...
          <div className="mx-[15px] mb-20 md:mb-0 md:mr-[15px] lg:mr-[60px] xl:mr-[15vw] pb-10">
            <div className="pt-24 h-full">
              ...
              <div className="flex mb-12 gap-2 text-sm mt-2">
                <p>
                  <br className="inline-block md:hidden" /> Shipping
                  Information
                </p>
                {/* <p>/</p> */}
                {/* <p>
                  02. <br className="inline-block md:hidden" /> Shipping Service
                </p>
                <p>/</p>
                <p>
                  03. <br className="inline-block md:hidden" /> Payment
                </p> */}
              </div>
